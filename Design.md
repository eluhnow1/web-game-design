...
- **Saw Blade**: Kills the player upon contact.
...
- **Themes**: Each level should have a different environmental theme, with varying floor colors and pixel art backgrounds.
  - **Examples**:
    - ![Desert](https://github.com/mcommons33/Edwins-web-game-design/blob/main/design-aesthetics/desert.png)
    - ![Forest](https://github.com/mcommons33/Edwins-web-game-design/blob/main/design-aesthetics/forest.png)
...
- **Level 1**: Order of pickups: left, crouch, jump, dash, double jump, wall jump.
  - ![Level One](https://github.com/mcommons33/Edwins-web-game-design/blob/main/assets/levels/level1.png)
